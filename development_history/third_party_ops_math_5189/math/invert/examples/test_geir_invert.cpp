...
#include "nn_other.h"
#include "../op_graph/invert_proto.h"
...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                         \
    ...
    invert1.set_input_##intputName(placeholder##intputIndex);                                               \
...
#define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                       \
    ...
    invert1.update_output_desc_##outputName(outputName##outputIndex##_desc);
