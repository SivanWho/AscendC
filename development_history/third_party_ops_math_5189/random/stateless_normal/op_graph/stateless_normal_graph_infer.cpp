...
/**
 * \file stateless_normal_graph_infer.cpp
 * \brief
 */
...
using namespace ge;
namespace ops {
static constexpr size_t STATELESS_NORMAL_OUT_ATTR_IDX = 0;

static ge::graphStatus InferDataTypeStatelessNormal(gert::InferDataTypeContext* context)
{
    int32_t mode = ops::GraphCommon::MODE_ATTR;
    int32_t dtypeIndex = STATELESS_NORMAL_OUT_ATTR_IDX;
...
IMPL_OP(StatelessNormal).InferDataType(InferDataTypeStatelessNormal);
} // namespace ops
