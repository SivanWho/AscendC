...
/*!
 * \file test_geir_drop_out_do_mask_v3.cpp
 * \brief
 */
...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                                 \
    do {                                                                                                            \
        ...
        dropoutdomaskv3.set_input_##intputName(placeholder##intputIndex);                                                      \
    ...
    Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto dropoutdomaskv3 = op::DropOutDoMaskV3("dropoutdomaskv3");
