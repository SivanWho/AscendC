...
class DropOutDoMaskV3Tiling : public testing::Test {
 protected:
...
TEST_F(DropOutDoMaskV3Tiling, drop_out_do_mask_v3_test_0)
{
    optiling::RandomOperatorCompileInfo compileInfo = {64, 253952};
    vector<float> keep_prob = {0.5};
    gert::TilingContextPara tilingContextPara(
        "DropOutDoMaskV3",
        {
            {{{32}, {32}}, ge::DT_FLOAT, ge::FORMAT_ND,},
            {{{128}, {128}}, ge::DT_UINT8, ge::FORMAT_ND,},
            {{{1}, {1}}, ge::DT_FLOAT, ge::FORMAT_ND, true, keep_prob.data()},
        },
        {
            {{{32}, {32}}, ge::DT_FLOAT, ge::FORMAT_ND},
        },
