...
> **Archived invalid experiment:** this version specializes the published shape and its accelerated int8 conversion saturates on adversarial overflow. It must not be submitted. The `7.26 us` value is a single published-case median, not a leaderboard score.
